...
BEGIN
    ...
    IF to_regclass('public.asset_groups') IS NOT NULL THEN
        IF to_regclass('public.asset_groups_id_seq') IS NULL THEN
    ...
    IF to_regclass('public.asset_sections') IS NOT NULL THEN
        IF to_regclass('public.asset_sections_id_seq') IS NULL THEN
            CREATE SEQUENCE asset_sections_id_seq;
        END IF;
    ...
    IF to_regclass('public.asset_units') IS NOT NULL THEN
        IF to_regclass('public.asset_units_id_seq') IS NULL THEN
            CREATE SEQUENCE asset_units_id_seq;
        END IF;
