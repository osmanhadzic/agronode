...
func NewRouter(logger *slog.Logger, telemetryService handlers.TelemetryQueryService, triggerService handlers.TriggerService, deviceService handlers.DeviceRegistrationService, realtimeHub *realtime.Hub) *gin.Engine {
	router := gin.New()
