...
func NewRouter(logger *slog.Logger, telemetryService handlers.TelemetryQueryService, triggerService handlers.TriggerService, realtimeHub *realtime.Hub) *gin.Engine {
	router := gin.New()
